...
from scripts.errorprone.Util import load_parsed_sb, CustomEncoder
...
if __name__ == '__main__':
    ...
    sb_file = "/home/yuliia/PycharmProjects/masters/results/bug/sb_parsed.json"
    sb_res_b = load_parsed_sb(sb_file)
       
    sb_file = "/home/yuliia/PycharmProjects/masters/results/fix/sb_parsed.json"
