...
from scripts.errorprone.Util import JsonDataReader, InferIssue, InferMsg, CustomEncoder, \
...
def parse_infer_json_output(proj, json_issue):
    ...
    if json_issue:
        ...
        infer_msg = InferMsg(proj, cls, issue.bug_type, issue.qualifier,
                             issue.severity, lines, issue.procedure)
...
if __name__ == '__main__':
    location_to_data = "/home/yuliia/PycharmProjects/masters/results/bug/inf_output_json"
...
#     time_stamp = time.strftime("%Y%m%d-%H%M%S")
    time_stamp = ''
    parsed_output_file_name = os.path.join(PATH_TO_RESULTS, "bug", "inf_parsed" + time_stamp + ".json")
