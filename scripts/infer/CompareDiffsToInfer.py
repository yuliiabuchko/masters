...
from scripts.errorprone.Util import load_parsed_diffs, load_parsed_inf, find_msg_by_proj_and_cls, \
                LineMatchesToMessages, CustomEncoder
from main import PATH_TO_RESULTS, BUG_FOLDER
...
if __name__ == '__main__':
    ...
    inf_file = os.path.join(PATH_TO_RESULTS, BUG_FOLDER, "inf_parsed.json")
